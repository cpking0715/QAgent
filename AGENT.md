...
- 输出：test-requirements.md、test-requirements.drawio、test-plan.md、risk.md、coverage-matrix.md、testcases.md、qa-review.md、testcases.xlsx
...
需求文档（PRD + 设计）
   ...
   ↓ Step 2  test-requirements.md + test-requirements.drawio
   ↓ Step 3  test-plan.md
   ↓ Step 4  risk.md
